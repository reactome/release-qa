...
public class T005_PathwaysWithoutEvents extends AbstractQACheck {
   
    private static final String ISSUE = "No child events";
    ...
    public QAReport executeQACheck() throws Exception {
        ...
        List<GKInstance> invalid = QACheckerHelper.getInstancesWithNullAttribute(dba,
                ReactomeJavaConstants.Pathway, ReactomeJavaConstants.hasEvent, null);
