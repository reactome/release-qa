...
public class T016_CatalystActivityWithoutActivity extends AbstractQACheck {

    private static final String ISSUE = "No activity";
    ...
    public QAReport executeQACheck() throws Exception {
        ...
        List<GKInstance> invalid = QACheckerHelper.getInstancesWithNullAttribute(dba,
                ReactomeJavaConstants.CatalystActivity, ReactomeJavaConstants.activity, null);
