...
public class T023_DatabaseIdentifierWithoutReferenceDatabase extends AbstractQACheck {

    private static final String ISSUE = "No reference database";
    ...
    public QAReport executeQACheck() throws Exception {
        ...
        List<GKInstance> invalid = QACheckerHelper.getInstancesWithNullAttribute(dba,
                ReactomeJavaConstants.DatabaseIdentifier, ReactomeJavaConstants.referenceDatabase, null);
