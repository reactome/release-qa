...
public class T013_ReferenceEntityWithoutIdentifier extends AbstractQACheck {

    private static final String ISSUE = "No identifier";
    ...
    public QAReport executeQACheck() throws Exception {
        ...
        List<GKInstance> invalid = QACheckerHelper.getInstancesWithNullAttribute(dba,
                ReactomeJavaConstants.ReferenceEntity, ReactomeJavaConstants.identifier, null);
