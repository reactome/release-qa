...
public class StableIdentifierCheck 
{
	...
	private static QAReport checkNullIdentifiers(MySQLAdaptor adaptor) throws Exception
	{
	...
	private static QAReport checkDuplicatedIdentifiers(MySQLAdaptor adaptor) throws Exception 
	{
	...
	public static void executeStableIdentifierCheck(String pathToResources)
	{
		try
		{
			...
			QAReport nullIdentifiersReport = checkNullIdentifiers(adaptor);

			QAReport duplicateIdentifiersReport = checkDuplicatedIdentifiers(adaptor);
